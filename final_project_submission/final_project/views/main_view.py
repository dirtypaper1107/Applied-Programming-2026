...
class MainView(QMainWindow):
    ...
    def __init__(self, view_model):
        ...
        self._load_and_show_offline_plot()
    ...
    def _build_control_panel(self) -> QWidget:
        ...
        self.offline_button = QPushButton("Load Offline Plot")
    ...
    def _show_offline_plot(self) -> None:
        ...
        if self.view_model.tcp_model.has_recording():
            self.view_model.emit_offline_plot()
        else:
            self.view_model.load_default_recording()

    def _load_and_show_offline_plot(self) -> None:
        self.tabs.setCurrentWidget(self.offline_plot)
        self.view_model.load_default_recording()
